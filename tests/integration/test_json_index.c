...
void setUp(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_json_index_create(db, "by_type", "type", &idx));
...
void test_json_lookup_string(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_lookup(idx, FASTKV_STR("admin"), count_cb, NULL));
...
void test_json_lookup_number(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_lookup(idx, FASTKV_STR("42"), collect_pk_cb, NULL));
...
void test_json_field_missing(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_lookup(idx, FASTKV_STR("apapun"), count_cb, NULL));
