...
typedef struct {
    ...
    fastkv_err_t (*get)(fastkv_engine_t *engine, fastkv_ts_t snapshot_ts, fastkv_slice_t key,
        fastkv_slice_t *value_out);

    fastkv_err_t (*put)(
        fastkv_engine_t *engine, fastkv_ts_t commit_ts, fastkv_slice_t key, fastkv_slice_t value);

    fastkv_err_t (*del)(fastkv_engine_t *engine, fastkv_ts_t commit_ts, fastkv_slice_t key);

    /* ordered iteration (for cursor + range-scan support) */
    fastkv_err_t (*iter_create)(fastkv_engine_t *engine, fastkv_ts_t snapshot_ts, void **iter_out);
