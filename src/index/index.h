...
typedef struct {
    ...
    fastkv_err_t (*on_put)(
        fastkv_index_impl_t *idx, fastkv_ts_t ts, fastkv_slice_t key, fastkv_slice_t value);

    fastkv_err_t (*on_delete)(fastkv_index_impl_t *idx, fastkv_ts_t ts, fastkv_slice_t key);

    /* Ordered iteration */
    fastkv_err_t (*iter_range)(fastkv_index_impl_t *idx, fastkv_ts_t snapshot_ts,
        fastkv_slice_t min_key, fastkv_slice_t max_key, fastkv_cursor_dir_t dir,
        fastkv_cursor_t **cursor_out);
} fastkv_index_ops_t;
