...
static int category_fn(fastkv_slice_t key, fastkv_slice_t value,
    fastkv_slice_t *ik_out, void *udata)
{
    (void)key;
    (void)udata;
...
void setUp(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_create(db, "by_cat", category_fn, NULL, &idx));
...
void test_lookup_basic(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_lookup(idx, FASTKV_STR("elektronik"), count_cb, NULL));
...
void test_lookup_single(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_lookup(idx, FASTKV_STR("buku"), collect_pk_cb, NULL));
...
void test_range_scan(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK,
        fastkv_index_range(idx, FASTKV_STR("a"), FASTKV_STR("c"), count_cb, NULL));
