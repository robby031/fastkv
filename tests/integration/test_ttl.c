...
void test_put_ttl_key_visible_before_expiry(void) {
    TEST_ASSERT_EQUAL_INT(
        FASTKV_OK, fastkv_put_ttl(db, FASTKV_STR("ttl_key"), FASTKV_STR("nilai"), 5000));
...
void test_put_ttl_key_expired_after_sync(void) {
    ...
    TEST_ASSERT_EQUAL_INT(
        FASTKV_OK, fastkv_put_ttl(db, FASTKV_STR("temp"), FASTKV_STR("sementara"), 100));
...
void test_ttl_renew(void) {
    ...
    TEST_ASSERT_EQUAL_INT(FASTKV_OK, fastkv_put_ttl(db, FASTKV_STR("renew"), FASTKV_STR("v"), 100));
    sleep_ms(50);
    /* perpanjang sebelum expired */
    TEST_ASSERT_EQUAL_INT(
        FASTKV_OK, fastkv_put_ttl(db, FASTKV_STR("renew"), FASTKV_STR("v2"), 5000));
