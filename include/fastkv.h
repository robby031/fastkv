...
fastkv_err_t fastkv_get(fastkv_db_t *db,
                        fastkv_slice_t key,
                        fastkv_slice_t *value_out); /* caller must fastkv_free_value() */

fastkv_err_t fastkv_put(fastkv_db_t *db,
                        fastkv_slice_t key,
                        fastkv_slice_t value);

fastkv_err_t fastkv_delete(fastkv_db_t *db,
                           fastkv_slice_t key);
...
fastkv_err_t fastkv_txn_begin(fastkv_db_t *db,
                              bool read_only,
                              fastkv_txn_t **txn);

fastkv_err_t fastkv_txn_get(fastkv_txn_t *txn,
                             fastkv_slice_t key,
                             fastkv_slice_t *value_out);

fastkv_err_t fastkv_txn_put(fastkv_txn_t *txn,
                             fastkv_slice_t key,
                             fastkv_slice_t value);

fastkv_err_t fastkv_txn_delete(fastkv_txn_t *txn,
                                fastkv_slice_t key);
...
typedef int (*fastkv_index_fn)(fastkv_slice_t key,
                                fastkv_slice_t value,
                                fastkv_slice_t *index_key_out,
                                void *udata);

fastkv_err_t fastkv_index_create(fastkv_db_t *db,
                                  const char *name,
                                  fastkv_index_fn fn,
                                  void *udata,
